                ...
                <div class="col-6 col-md-4 order-3 order-md-3 text-right">
                    <div class="site-top-icons">
                        <ul>
                            ...
                            <li>
                                <a href="../ecommerce/cart.jsp" class="site-cart">
    ...
    <nav class="site-navigation text-right text-md-center" role="navigation">
        <div class="container">
            <ul class="site-menu js-clone-nav d-none d-md-block" style="padding: 0">
                <li class="${home_active}"><a href="/ecommerce">Home</a></li>
                <li class="${about_active}"><a href="../ecommerce/about.jsp">About</a></li>
                <li class="${shop_active}"><a href="shop">Shop</a></li>
                <li class="${contact_active}"><a href="../ecommerce/contact.jsp">Contact</a></li>
